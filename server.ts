...
import { analyzeContext } from './src/backend/pipeline/contextAnalyzer.js';
import { detectIntent } from './src/backend/pipeline/intentDetector.js';
import { buildWorkflowPlan } from './src/backend/pipeline/planner.js';
import { executeWorkflowPlan } from './src/backend/pipeline/executor.js';
import { buildFinalPrompt } from './src/backend/pipeline/promptBuilder.js';
import { streamModelResponse } from './src/backend/pipeline/provider.js';
import { memoryManager } from './src/backend/memory/memoryManager.js';
import { toolRegistry } from './src/backend/tools/toolRegistry.js';
import { agentOrchestrator } from './src/backend/agents/agentOrchestrator.js';
import { historyManager } from './src/backend/services/historyManager.js';
import { Message, PipelineEvent } from './src/backend/types.js';
...
async function startServer() {
  ...
  app.post('/api/chat/stream', async (req, res) => {
    ...
    try {
      ...
      sendSSE('complete', { message: assistantMsg });
      res.end();
    } catch (err: unknown) {
